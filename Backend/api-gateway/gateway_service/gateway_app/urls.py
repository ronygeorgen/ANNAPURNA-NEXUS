...
from .views import RegisterView, LoginView, LogoutView,AdminLoginView, CreateSubAdminView, SubAdminLoginView, CreateRationShopView, GetSubAdminView, RefreshView
urlpatterns = [
